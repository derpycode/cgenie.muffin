...
User-configuration files are provided (this directory) for all 28 different time-slices, but all for modern pO2 and ocean SO4, and for the default POM reminerilization depth (590 m).
