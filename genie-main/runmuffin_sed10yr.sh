...
dstp=$((3600*24*36525/100/$datmstp/$N_TIMESTEPS))  # when computer does not have bc 
echo "   Setting primary model time step: " $dstp
# read -p "Press [Enter] key to resume."
dsedstp=960
echo "***** Assuming less time duration for sedgem: " $dsedstp
...
echo ma_conv_kocn_ksedgem=$dsedstp >> $CONFIGPATH/$CONFIGNAME
