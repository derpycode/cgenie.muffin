...
CODEDIR=/work/crct/CCUBlogin/cgenie.muffin
OUTROOT=/work/crct/CCUBlogin/cgenie_output
ARCHIVEDIR=/work/crct/CCUBlogin/cgenie_archive
LOGDIR=/work/crct/CCUBlogin/cgenie_log
