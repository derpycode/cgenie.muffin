...
CODEDIR=/work/c-ccub/CCUBlogin/cgenie.muffin
OUTROOT=/work/c-ccub/CCUBlogin/cgenie_output
ARCHIVEDIR=/work/c-ccub/CCUBlogin/cgenie_archive
LOGDIR=/work/c-ccub/CCUBlogin/cgenie_log
