...
! ******************************************************************************************************************************** !
! COUPLE FLUXES: reg->atm
SUBROUTINE cpl_flux_regatm(    &
     & dum_dts,                 &
     & dum_n_maxatm,            &
  ...
  ! NOTE: reg->atm flux (reg grid) <dum_sfxatm> in units of (mol m-2 s-1)
  ! NOTE: reg->atm flux (atm grid) <dum_sfxatm1> in units of (mol m-2 s-1)
...
!!! *****************************************
end SUBROUTINE cpl_flux_regatm
! ******************************************************************************************************************************** !
