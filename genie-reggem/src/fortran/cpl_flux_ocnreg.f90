...
! ******************************************************************************************************************************** !
! COUPLE fluxes surface (embm) -> reggem
SUBROUTINE cpl_flux_ocnreg()
  ...
  !  real,dimension(dum_n_rok,dum_n_i_rok,dum_n_j_rok),intent(out)::dum_sfxsumrok ! surface(embm)->rocks fluxes; integrated, reggem grid
  ! \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/ !
  ! ANY DIFFERENCE BETWEEN OCEAN AND reggem GRIDS WILL HAVE TO BE TAKEN INTO ACCOUNT HERE
  ! integrate flux to reggem <dum_sfxrok1> (mol m-2 s-1)
  ! running total <dum_sfxsumrok> is in units of (mol m-2)
  !  dum_sfxsumrok(:,:,:) = dum_sfxsumrok(:,:,:) + dum_dts*dum_sfxrok1(:,:,:)
  ! zero flux - put in initialise_reggem when in use
  !  dum_sfxrok1(:,:,:) = 0.0
  ! /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ !
END SUBROUTINE cpl_flux_ocnreg
! ******************************************************************************************************************************** !
