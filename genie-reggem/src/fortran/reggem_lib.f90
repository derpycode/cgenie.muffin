...
! File: reggem_lib.f90
! 
! Description: this is the library module contains all the variable allocations for RegGeM
!
! Uses:
!
! - <genie_control>
...
MODULE reggem_lib
  ...
  NAMELIST /ini_reggem_nml/ctrl_continuing
  REAL::start_year                                                                       ! Simulation start year [real]
  NAMELIST /ini_reggem_nml/start_year
  ! ------------------- I/O DEFINITIONS ------------------------------------------------------------------------------------------ !
  CHARACTER(len=255)::par_indir_name,par_outdir_name,par_rstdir_name,par_pindir_name                     ! 
  NAMELIST /ini_reggem_nml/par_indir_name,par_outdir_name,par_rstdir_name,par_pindir_name
  CHARACTER(len=63)::par_infile_name,par_outfile_name                                    ! 
  NAMELIST /ini_reggem_nml/par_infile_name,par_outfile_name
  logical::opt_screen_output                                                             ! output to screen
  NAMELIST /ini_reggem_nml/opt_screen_output
  ...
  NAMELIST /ini_reggem_nml/par_output_years_file_0d,par_output_years_file_2d
  ...
  NAMELIST /ini_reggem_nml/opt_2d_ascii_output,opt_2d_netcdf_output,opt_append_data
  ! --- RIVER ROUTING PARAMETERS ------------------------------------------------------------------------------------------------- !
  INTEGER::routing_scheme                                                                ! routing scheme to use: 1 = 'roof' routing using k1 file; 
  NAMELIST /ini_reggem_nml/routing_scheme                                                ! 2 = intermediate using detailed map, but roof for stuff that ends up on genie land grid (about half)
  ...
  NAMELIST /ini_reggem_nml/opt_weather_CaCO3,opt_weather_CaSiO3
  ...
  NAMELIST /ini_reggem_nml/opt_weather_T_Ca,opt_weather_T_Si,opt_weather_Talt_Si
  NAMELIST /ini_reggem_nml/opt_weather_R_explicit,opt_weather_R_Ca,opt_weather_R_Si
  ...
  NAMELIST /ini_reggem_nml/opt_weather_C_Ca,opt_weather_C_Si,opt_weather_C_Si_bg
  ...
  NAMELIST /ini_reggem_nml/par_nCa,par_nSi
  ...
  NAMELIST /ini_reggem_nml/opt_weather_P_explicit,opt_weather_P_Ca,opt_weather_P_Si
  CHARACTER(len=63)::par_prodopt                                                         ! prodictivity to use ("GPP" or "NPP")
  NAMELIST /ini_reggem_nml/par_prodopt
  ...
  NAMELIST /ini_reggem_nml/par_k_Ca,par_k_Si,par_E_a  
  REAL:: par_k_Tb                                                                          ! Exponent for basalt weathering
  REAL:: par_k_Tg                                                                          ! Exponent for granite weathering
  NAMELIST /ini_reggem_nml/par_k_Tb,par_k_Tg
  REAL:: par_k_run                                                                       ! constant for temperature-runoff linear correlation
  REAL:: par_beta                                                                        ! frac. power of explicit weathering-runoff dependence  NAMELIST /ini_reggem_nml/par_k_Ca,par_E_a,par_k_run
  NAMELIST /ini_reggem_nml/par_k_run,par_beta
  ...
  NAMELIST /ini_reggem_nml/par_ref_T0,par_ref_R0,par_ref_P0,par_ref_CO20 
  LOGICAL:: opt_outgas_eq_Si
  NAMELIST /ini_reggem_nml/opt_outgas_eq_Si                                              ! set volcanic outgassing equal to silicate weathering
  REAL:: par_outgas_CO2                                                                  ! CO2 outgassing rate (mol C yr-1)
  REAL:: par_outgas_CO2_d13C                                                             ! mean volcanic/metamorphic d13C (o/oo)
  NAMELIST /ini_reggem_nml/par_outgas_CO2,par_outgas_CO2_d13C          
  ! ------------------- GLOBAL AVERAGE WEATHERING PARAMETERS --------------------------------------------------------------------- !
  REAL:: par_weather_CaSiO3                                                              ! global silicate weathering rate (mol ALK yr-1)
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3b,par_weather_CaSiO3g
  REAL:: par_weather_CaSiO3_fracMg                                                       ! global (Ca silicate) Mg relative abundance
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracMg
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3b_fracMg,par_weather_CaSiO3g_fracMg
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracSi,par_weather_CaSiO3_fracSi_d30Si
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracFeS2,par_weather_CaSiO3_fracFeS2_d34S,par_weather_CaSiO3_fracFeS2_d56Fe
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaCO3_fracCaSO4,par_weather_CaCO3_fracCaSO4_d34S,par_weather_CaCO3_fracCaSO4_d44Ca  
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaCO3_fracFeCO3,par_weather_CaCO3_fracFeCO3_d56Fe,par_weather_CaCO3_fracFeCO3_d13C
  real:: par_weather_CaSiO3_fracLi                                                       ! global silicate Li relativeabundance
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracLi
  ...
  NAMELIST /ini_reggem_nml/par_weather_Li_Rscale,par_weather_Li_Roffset
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_Li_d7Li,par_weather_Li_7Li_epsilon
  REAL:: par_weather_CaSiO3_d44Ca                                                        ! 
  REAL:: par_weather_CaCO3_d44Ca                                                         ! 
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_d44Ca,par_weather_CaCO3_d44Ca
  REAL::par_weather_CaSiO3_fracSr                                                        ! global silicate Sr abundance
  REAL::par_weather_CaCO3_fracSr                                                         ! global carbonate Sr abundance     
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracSr,par_weather_CaCO3_fracSr
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracOs,par_weather_CaCO3_fracOs
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_187Os_188Os,par_weather_CaCO3_187Os_188Os
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_188Os_192Os,par_weather_CaCO3_188Os_192Os
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_fracCa5PO43,par_weather_CaSiO3_fracCa5PO43_d44Ca
  REAL::par_weather_Ca0PO41                                                              ! global apatite weathering rate (mol PO4 yr-1)
  NAMELIST /ini_reggem_nml/par_weather_Ca0PO41  
  REAL::par_weather_SiO2                                                                 ! global quartz weathering rate (mol Si yr-1)
  REAL::par_weather_SiO2_d30Si                                                           ! global quartz d30Si (o/oo)
  NAMELIST /ini_reggem_nml/par_weather_SiO2,par_weather_SiO2_d30Si  
  ...
  NAMELIST /ini_reggem_nml/par_weather_kerogen_fracP,par_weather_kerogen_fracALK  
  ...
  NAMELIST /ini_reggem_nml/par_weather_kerogen_fracS,par_weather_kerogen_fracS_d34S  
  ...
  NAMELIST /ini_reggem_nml/opt_calibrate_T_0D,opt_calibrate_R_0D,opt_calibrate_P_0D
  ...
  NAMELIST /ini_reggem_nml/par_data_T_0D,par_data_R_0D,par_data_P_0D
  ...
  NAMELIST /ini_reggem_nml/par_n_max_CaCO3,par_n_max_CaSiO3
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaCO3_enh_n,par_weather_CaSiO3_enh_n
  ...
  NAMELIST /ini_reggem_nml/par_weather_CaCO3_enh_nt,par_weather_CaSiO3_enh_nt
  CHARACTER(len=63)::opt_weather_CaSiO3_fracLi                                           ! Li weathering scheme
  NAMELIST /ini_reggem_nml/opt_weather_CaSiO3_fracLi
  LOGICAL::ctrl_weather_CaSiO3_7Li_epsilon_fixed                                         ! Fixed (non T-dep) clay fractionation?
  NAMELIST /ini_reggem_nml/ctrl_weather_CaSiO3_7Li_epsilon_fixed
  REAL::par_weather_CaSiO3_7Li_epsilon_DT                                                ! T-dependent D7Li sensitivity (o/oo K-1)
  NAMELIST /ini_reggem_nml/par_weather_CaSiO3_7Li_epsilon_DT
  ...
  NAMELIST /ini_reggem_nml/opt_weather_fixed_CaCO3,opt_weather_fixed_CaSiO3  
  NAMELIST /ini_reggem_nml/opt_weather_fixed_Li,opt_weather_fixed_Sr,opt_weather_fixed_Os  
...
!!!  ! ------------------- 2D WEATHERING PARAMETERS --------------------------------------------------------------------------------- !
  ...
  NAMELIST /ini_reggem_nml/par_lith_data,par_lith_data2,par_lith_data3                   ! name of lithological data set - corresponding to directory genie-reggem/data/input/lithologies_par_lith_datapar_lith_data2par_lith_data3_036_036
...
!!!  NAMELIST /ini_reggem_nml/opt_weath_regimes,weath_regimes
  ...
  ! *** array dimensions ***
  ! grid dimensions
  INTEGER,PARAMETER::n_i                                  = ilon1_reg ! 
  INTEGER,PARAMETER::n_j                                  = ilat1_reg ! 
  ! grid properties array dimensions 
  INTEGER,PARAMETER::n_phys_reg                           = 08    ! number of grid properties descriptors
  INTEGER,PARAMETER::n_phys_ocnreg                        = 06    ! number of grid properties descriptors

  ! *** PRIMARY reggem ARRAYS ***
  real,dimension(n_phys_reg,n_i,n_j)::phys_reg                                         ! 'physical' array info - see below (lats, lons, areas of grid cells)
  ...
  CHARACTER(len=16),DIMENSION(n_phys_reg),PARAMETER::string_phys_reg = (/ &
       & 'lat             ', &
       & 'latn            ', &
       & 'lon             ', &
       & 'lone            ', &
  ...
  INTEGER,PARAMETER                              ::n_io = ilon1_reg
  INTEGER,PARAMETER                              ::n_jo = ilat1_reg
  INTEGER,PARAMETER                              ::n_ko = inl1_ocn                                 ! no. of depth levels in ocean
  REAL,DIMENSION(n_phys_ocnreg,n_io,n_jo)        ::phys_ocnreg                                     ! 'physical' array info for ocean-atmosphere - see above (lats, lons, areas of grid cells)
  ...
  CHARACTER(len=7)                               :: string_ncrunid_gg                              ! netCDF runID
  CHARACTER(len=254)                             :: string_ncout2d_gg                              ! netCDF output filename
  INTEGER                                        :: ncout2d_ntrec_gg                               ! count for netcdf datasets
  INTEGER                                        :: ncout2d_iou_gg                                 ! io for netcdf datasets
