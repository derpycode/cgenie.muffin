...
CONTAINS
  ...
  SUBROUTINE sub_calc_ads_PO4_POM_FeOOH(dum_i,dum_j,dum_k1,dum_dtyr)
    ...
    ! -------------------------------------------------------- !
    INTEGER::k
    real,dimension(n_k)::loc_PO4_ads
    real::loc_f
    ! -------------------------------------------------------- !
    ! INITIALIZE VARIABLES
    ! -------------------------------------------------------- !
    ...
    loc_PO4_ads = 0.0 
    DO k=n_k,dum_k1,-1
       loc_PO4_ads(k) = ocn_ads_POM_FeOOH_dPO4(dum_i,dum_j,k)*1e-6
    enddo 
    ! -------------------------------------------------------- !
    ! SET GLOBAL ARRAYS
    ! -------------------------------------------------------- !
    ! -------------------------------------------------------- ! TRACER CONCENTRATIONS
    bio_remin(io_PO4,dum_i,dum_j,:) = bio_remin(io_PO4,dum_i,dum_j,:) - loc_PO4_ads(:)
    ! -------------------------------------------------------- ! PARTICULATE CONCENTRATIONS
    ! -------------------------------------------------------- !
    ! DIAGNOSTICS
    ! -------------------------------------------------------- !
