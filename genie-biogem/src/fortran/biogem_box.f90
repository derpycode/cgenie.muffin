...
!!$                   end do
  ...
  SUBROUTINE sub_box_scav_Os(dum_dtyr,dum_dt_scav,dum_ocn_Os,dum_ocn_Os_187Os,dum_ocn_Os_188Os,dum_ocn_O2,dum_bio_part,dum_bio_remin)
    ...
    ! NOTE: select if scavenging should be dependent on ambient O2 concentration. If yes, Os is only scavenged below an adjustable O2 threshold
