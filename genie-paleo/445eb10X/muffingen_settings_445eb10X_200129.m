...
%
par_wor_name='445eb10X';       % ['worblank'] 8-char (output) config name
par_gcm='foam';                    % [''] input format/GCM name
par_expid='445eb_1318.1W_EccN_2800ppm';                  % [''] input experiment/data name
...
par_nc_topo_name  = 'Topobathy_445eb_postslarti_cor';        % [''] optional .nc name
par_nc_mask_name  = 'Topobathy_445eb_postslarti_cor';        % [''] optional .nc name
par_nc_axes_name  = 'Topobathy_445eb_postslarti_cor';        % [''] optional .nc name
par_nc_atmos_name = '445eb_1318.1W_EccN_atmos_2800ppm';        % [''] optional .nc name
par_nc_ocean_name = '445eb_1318.1W_EccN_ocean_2800ppm';        % [''] optional .nc name
par_nc_coupl_name = '445eb_1318.1W_EccN_coupl_2800ppm';        % [''] optional .nc name
%
