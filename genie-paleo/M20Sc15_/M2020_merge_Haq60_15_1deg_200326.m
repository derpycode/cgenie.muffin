...
%
par_wor_name='M20Sc15_';       % ['STRING'] 8-char (output) config name
par_gcm='mat';                 % ['STRING'] input format/GCM name
par_expid='INPUT/M2020_merge_Haq60_15_1deg';% ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_age=15.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
