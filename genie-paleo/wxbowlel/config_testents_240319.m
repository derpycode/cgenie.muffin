...
%
par_wor_name='wxbowlel';       % ['worxbowl'] 8-char (output) config name
...
par_A_frac_threshold=0.37;     % [0.5] fractional area threshold for ocean
...
opt_makeents=true;             % [false/true] re-gridding ENTS input files?
%
% *** GRID FILTERING **************************************************** %
%
