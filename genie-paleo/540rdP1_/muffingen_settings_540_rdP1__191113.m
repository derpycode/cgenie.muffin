...
%
par_wor_name='540rdP1_';       % ['worblank'] 8-char (output) config name
par_gcm='foam';                    % [''] input format/GCM name
par_expid='540rd_1368W_EccN_2240ppm';                  % [''] input experiment/data name
...
par_nc_topo_name  = 'Topobathy_540eb_postslarti_cor';        % [''] optional .nc name
par_nc_mask_name  = 'Topobathy_540eb_postslarti_cor';        % [''] optional .nc name
par_nc_axes_name  = 'Topobathy_540eb_postslarti_cor';        % [''] optional .nc name
par_nc_atmos_name = '540rd_1368W_EccN_atmos_2240ppm';        % [''] optional .nc name
par_nc_ocean_name = '540rd_1368W_EccN_ocean_2240ppm';        % [''] optional .nc name
par_nc_coupl_name = '540rd_1368W_EccN_coupl_2240ppm';        % [''] optional .nc name
%
