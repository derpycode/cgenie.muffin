...
%
par_wor_name='wwater';         % ['wworld'] 6-char (output) config name
par_gcm='mask';                % ['dat'] input format/GCM name
par_expid='wwater';            % ['wwater'] input experiment/data name
par_pathin='INPUT.EXAMPLES';   % ['INPUT.EXAMPLES'] path to input dir
par_pathout='OUTPUT.EXAMPLES'; % ['OUTPUT.EXAMPLES'] path to output dir
