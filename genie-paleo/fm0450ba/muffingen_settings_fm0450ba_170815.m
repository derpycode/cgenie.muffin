...
%
par_wor_name='fm0450ba';         % ['wworld'] 6-char (output) config name
...
par_nc_atmos_name='450Ma_Blakey.HSO.atmos.T+4_16X'; % [''] optional .nc name
par_nc_ocean_name='450Ma_Blakey.HSO.ocean.T+4_16X'; % [''] optional .nc name
par_nc_coupl_name='450Ma_Blakey.HSO.coupl.T+4_16X_regrid'; % [''] optional .nc name
%
