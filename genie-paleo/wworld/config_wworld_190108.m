...
%
par_wor_name='worwater';       % ['worworld'] 8-char (output) config name
par_gcm='mask';                % ['dat'] input format/GCM name
par_expid='worwater';          % ['worwater'] input experiment/data name
...
par_tauopt=2;                  % [0/1/2] zonal windstress generation option
