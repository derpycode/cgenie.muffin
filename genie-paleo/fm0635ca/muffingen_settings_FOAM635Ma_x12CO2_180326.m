...
%
par_wor_name='fm0635ca';         % ['wworld'] 6-char (output) config name
par_gcm='foam';             % ['hadcm3l'] input format/GCM name
par_expid='Andy_635Ma';             % ['xbomg'] experiment name
...
par_nc_atmos_name='635Ma.atmos.12x'; % [''] -- optional/specific .nc file name
par_nc_coupl_name='635Ma.coupl.12x'; % [''] -- optional/specific .nc file name
par_nc_ocean_name='635Ma.ocean.12x'; % [''] -- optional/specific .nc file name
%
...
par_age=635.0;                   % [0.0] optional age of paleo configuration
%
% *** OPTIONS -- MAIN *************************************************** %
%
