...
%
par_wor_name='Scot365M';       % ['STRING'] 8-char (output) config name
par_gcm='.mat';                  % ['STRING'] input format/GCM name
par_expid='Scotese_map65.5_360x180_1deg_365Ma';            % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_age=365.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
