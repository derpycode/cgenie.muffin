...
%   ***********************************************************************
%
%   NOTE PV: PV30 has different land-sea mask to PV05 but same shelf area
%            that was based on PV05. This represents an 'equal-sign' world
%            designed to reflect tethys epicontintnal seaways
%   NOTE PV: Use seds from PV05
%
%   ***********************************************************************
...
%
par_wor_name='fkl_PV31';        % ['STRING'] 8-char (output) config name
par_gcm='k1';                   % ['STRING'] input format/GCM name
par_expid='fkl_PV05';           % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_tauopt=0;                  % [0/1/2/3] zonal windstress option
