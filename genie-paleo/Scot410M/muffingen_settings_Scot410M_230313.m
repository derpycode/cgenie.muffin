...
%
par_wor_name='Scot410M';       % ['STRING'] 8-char (output) config name
par_gcm='.mat';                  % ['STRING'] input format/GCM name
par_expid='Scotese_map71_360x180_1deg_410Ma';            % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_age=410.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
