...
%
par_wor_name='umxooeva';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3';             % ['STRING'] input format/GCM name
par_expid='xooev';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='DATA';   % ['STRING'] path to input dir
...
par_age=252.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
