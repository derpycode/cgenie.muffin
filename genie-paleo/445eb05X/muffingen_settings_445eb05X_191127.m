...
%
par_wor_name='445eb05X';       % ['worblank'] 8-char (output) config name
par_gcm='foam';                    % [''] input format/GCM name
par_expid='445eb_1318.1W_EccN_1400ppm';                  % [''] input experiment/data name
...
par_nc_atmos_name = '445eb_1318.1W_EccN_atmos_1400ppm';        % [''] optional .nc name
par_nc_ocean_name = '445eb_1318.1W_EccN_ocean_1400ppm';        % [''] optional .nc name
par_nc_coupl_name = '445eb_1318.1W_EccN_coupl_1400ppm';        % [''] optional .nc name
%
