...
%
par_wor_name='w_foam';         % ['wblank'] 6-char (output) config name
par_gcm='k1';                  % [''] input format/GCM name
par_expid='w_foam';            % [''] input experiment/data name
par_pathin='_OLD.DATA.k1';   % ['EXAMPLES.INPUT'] path to input dir
