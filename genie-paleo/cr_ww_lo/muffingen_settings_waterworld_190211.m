...
%
par_wor_name='cr_ww_lo';       % ['worworld'] 8-char (output) config name
par_gcm='';                % ['dat'] input format/GCM name
par_expid='';          % ['worwater'] input experiment/data name
par_pathin='';   % ['EXAMPLES.INPUT'] path to input dir
