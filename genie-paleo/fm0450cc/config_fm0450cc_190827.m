...
%
par_wor_name='fm0450cc';         % ['wworld'] 6-char (output) config name
...
par_nc_atmos_name='450Ma_TPD_DesHSO_atmos_10X'; % [''] optional .nc name
par_nc_ocean_name='450Ma_TPD_DesHSO_ocean_10X'; % [''] optional .nc name
par_nc_coupl_name='450Ma_TPD_DesHSO_coupl_10X_regrid'; % [''] optional .nc name
%
