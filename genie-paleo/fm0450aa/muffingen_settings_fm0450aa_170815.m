...
%
par_wor_name='fm0450aa';         % ['wworld'] 6-char (output) config name
...
par_nc_atmos_name='450Ma_Blakey.HSO.atmos.24XR0'; % [''] optional .nc name
par_nc_ocean_name='450Ma_Blakey.HSO.ocean.24XR0'; % [''] optional .nc name
par_nc_coupl_name='450Ma_Blakey.HSO.coupl.24XR0_regrid'; % [''] optional .nc name
%
