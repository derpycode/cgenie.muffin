...
%
par_wor_name='umtdqpmb';         % ['wworld'] 6-char (output) config name
par_gcm='hadcm3l';             % ['hadcm3l'] input format/GCM name
par_expid='tdqpm';             % ['xbomg'] experiment dir
...
par_min_k=1;                   % [1] # minimum ocean depth level
...
%
par_age=14.0;                   % [0.0] optional age of paleo configuration
