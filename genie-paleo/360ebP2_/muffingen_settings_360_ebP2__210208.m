...
%
par_wor_name='360ebP2_';       % ['STRING'] 8-char (output) config name
...
%
par_nc_topo_name  = 'Topobathy_360eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_360eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_360eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '360ebP2_solCgough1981_EccN_pCO2FosterKr_atmos_slab';        % ['STRING'] optional .nc name
par_nc_ocean_name = '360ebP2_solCgough1981_EccN_pCO2FosterKr_coupl_slab';        % ['STRING'] optional .nc name
par_nc_coupl_name = '360ebP2_solCgough1981_EccN_pCO2FosterKr_coupl_slab';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
