...
%
par_wor_name='utexPk1a';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3';             % ['STRING'] input format/GCM name
par_expid='texPk1';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='../DATA.UM.Scotese';   % ['STRING'] path to input dir
par_pathout='../OUTPUT.UM.Scotese'; % ['STRING'] path to output dir
...
par_age=178.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
