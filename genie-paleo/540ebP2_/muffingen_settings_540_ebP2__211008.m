...
%
par_wor_name='540ebP2_';       % ['STRING'] 8-char (output) config name
...
%
par_nc_topo_name  = 'Topobathy_540eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_540eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_540eb_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '540ebP2_solCgough1981_EccN_pCO2FosterKr_atmos_slab';        % ['STRING'] optional .nc name
par_nc_ocean_name = '540ebP2_solCgough1981_EccN_pCO2FosterKr_coupl_slab';        % ['STRING'] optional .nc name
par_nc_coupl_name = '540ebP2_solCgough1981_EccN_pCO2FosterKr_coupl_slab';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
...
par_age=540.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
