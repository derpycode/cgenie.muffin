...
%
par_wor_name='Vera383M';       % ['STRING'] 8-char (output) config name
par_gcm='.mat';                  % ['STRING'] input format/GCM name
par_expid='Verard_map_360x180_1deg_383Ma';            % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_age=383.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
