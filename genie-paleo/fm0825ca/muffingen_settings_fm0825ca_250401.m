...
%
par_wor_name='fm0825ca';       % ['STRING'] 8-char (output) config name
par_gcm='foam';             % ['STRING'] input format/GCM name
par_expid='825Ma';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
%
par_nc_topo_name  = 'Topobathy_825Ma_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_825Ma_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_825Ma_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '825Ma_1278.25W_OrdPD_atmos_6720ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '825Ma_1278.25W_OrdPD_coupl_6720ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '825Ma_1278.25W_OrdPD_coupl_6720ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
...
par_age=825.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
