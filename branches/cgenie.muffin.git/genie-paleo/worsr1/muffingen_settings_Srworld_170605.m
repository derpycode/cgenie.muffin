...
%
par_wor_name='worsr1';         % ['wblank'] 6-char (output) config name
par_gcm='k1';                  % [''] input format/GCM name
par_expid='worsr1';            % [''] input experiment/data name
...
%
par_max_i=12;                  % [36] # grid cells in longitude dir (i)
par_max_j=12;                  % [36] # grid cells in latitude  dir (j)
