...
%
par_wor_name='fm0000aa';         % ['wworld'] 6-char (output) config name
...
par_nc_topo_name='Topobathy_ctrlAC_postslarti';     % [''] optional .nc name
par_nc_atmos_name='CTRL.AP.atmos.ctrlAC_1370W'; % [''] optional .nc name
par_nc_ocean_name=''; % [''] optional .nc name
par_nc_coupl_name='CTRL.AP.coupl.ctrlAC_1370W_regrid'; % [''] optional .nc name
%
