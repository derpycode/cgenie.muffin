...
%
par_wor_name='UM013a';         % ['wworld'] 6-char (output) config name
par_gcm='hadcm3l';             % ['hadcm3l'] input format/GCM name
par_expid='tdqpm';             % ['xbomg'] experiment name
par_pathin='../DATA.UM';   % ['EXAMPLES.INPUT'] path to input dir
...
%par_nc_atmos_name='450Ma_Blakey.CSO.atmos.24XR0'; % [''] optional .nc name
%par_nc_ccean_name='450Ma_Blakey.CSO.ocean.24XR0'; % [''] optional .nc name
%par_nc_coupl_name='450Ma_Blakey.CSO.coupl.24XR0'; % [''] optional .nc name
%
...
%
par_age=13.0;                   % [0.0] optional age of paleo configuration
