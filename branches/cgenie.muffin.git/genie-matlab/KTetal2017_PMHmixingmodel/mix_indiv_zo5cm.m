...
load('SedRate0.53_k6_zo5_zs1.5.mat', 'histarch')    % point mixing profiles
mix1=histarch; clear histarch
%------------%------------%------------%------------%------------%
%% Process and Calculate Typical Sediment Mixing Profile

% Extract mixing profile & trim 
sedRate=0.53;  	% cm/kyr; sed. rate (from generating point mixing code)
...
save ('mixed_taxa-stepchange-zo5s0p53k6-gap0gap10-ab50ab2p5.mat', 'section','sCell','tCell', 'sAbund',...
